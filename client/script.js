...
// const buttonColor = sayHelloButton.textContent
...
// CODE HERE
function sayHelloButtonBlack() {
    sayHelloButton.style.backgroundColor = `BLACK`
    sayHelloButton.style.color = `white`
}

sayHelloButton.addEventListener(`mouseover`, sayHelloButtonBlack)
...
// CODE HERE
function sayHelloButtonWhite() {
    sayHelloButton.style.backgroundColor = `#EFEFEF`
    sayHelloButton.style.color = `black`
}

sayHelloButton.addEventListener(`mouseout`, sayHelloButtonWhite)
...
/*
    ...
    Handle the promise that's returned with a .then, which you should pass a callback function too. Inside the callback function, console.log the response's data (in the intermediate instructions we'll come back to this function and add HTML).
*/ 
...
const repeatMyParam = () => {
    ...
    axios.get(`http://localhost:3000/repeat/john`)
    .then(res => {
...
// CODE HERE
function gitRequest() {
    axios.get('http://localhost:3000/query-test/?query=jane/?query=tom')
    console.log(`amogus`)
}

document.getElementById(`query-button`).addEventListener(`click`, gitRequest)
...
document.getElementById(`form-button`).addEventListener(`click`, createFood)